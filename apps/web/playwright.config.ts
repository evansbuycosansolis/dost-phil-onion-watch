  ...
  webServer: [
    {
      ...
      env: {
        ...process.env,
        DATABASE_URL: `sqlite+pysqlite:///./app/tests/tmp/e2e-web-${runId}.db`,
        FAISS_INDEX_PATH: `./app/tests/tmp/e2e-web-${runId}.index`,
        FAISS_METADATA_PATH: `./app/tests/tmp/e2e-web-${runId}-meta.json`,
        REPORTS_PATH: `./app/tests/tmp/e2e-web-${runId}-reports`,
