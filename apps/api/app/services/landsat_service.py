...
class LandsatAdapter(SatelliteAdapter):
    source = "landsat"
    _collections = ("landsat-c2-l2", "landsat-8-c2-l2", "landsat-9-c2-l2")
    ...
    def discover_scenes(
        ...
        *,
        ...
        for item in items:
            ...
            cloud = normalize_cloud_score(
                props.get("eo:cloud_cover") or props.get("landsat:cloud_cover_land") or props.get("cloud_cover")
            )
