...
from app.services.stac_service import geojson_to_bbox, stac_item_datetime, stac_search_items


class Sentinel1Adapter(SatelliteAdapter):
    source = "sentinel1"

    _collections = ("sentinel-1-grd", "sentinel-1-grd-cogs")
    ...
    def discover_scenes(
        ...
        *,
        ...
        for item in items:
            ...
            bands = sorted(list(assets.keys())) if isinstance(assets, dict) else ["vv", "vh"]
